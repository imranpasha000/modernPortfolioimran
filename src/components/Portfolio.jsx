    ...
    return (
        <div id="work" className="mt-10 relative">
            ...
            <Div className="mb-10">
                ...
                Previous company projects involve diverse software development, spanning web apps, mobile solutions, databases, and possibly AI, focusing on specific domains like e-commerce
                 or healthcare, all aiming for functional, reliable solutions through team efforts.
                </div>
            </Div>
            {/* SECTION HEADING END */}
