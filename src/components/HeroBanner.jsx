            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>Pashaturki19081@gmail.com</div>
                        <div> Pashaimran0047@gmail.com</div>
                        <div> +91 9639328205</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Mohammad Imran</span>
                    </div>
                    <div className="max-w-[510px]">
                        I create and maintain modern websites and applications.
                        Good analytical thinking with a practical approach to problem 
                        solving.
                    </div>
                </motion.div>
                {/* INTRO END */}
